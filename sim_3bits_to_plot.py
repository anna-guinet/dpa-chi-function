...
def find_rank(inter):
	...
	if inter:
		...
		rank = [1 + count for count in range(len(inter), 0, -1)]
...
def sim_3bits(n, K, kappa, num_sim):
	...
	correct0 = [fct_scalar(w, correct_init0, 24) for w in interval]
	ax1.plot(interval, correct0, '-', color='tab:red', markersize=1, label='%s %s' % (correct_idx[0][0], correct_idx[0][1]))

	# Degenerate case
	if (correct_init1 != None):
		correct1 = [fct_scalar(w, correct_init1, 24) for w in interval]
		ax1.plot(interval, correct1, '-', color='tab:red', markersize=1, label='%s %s' % (correct_idx[1][0], correct_idx[1][1]))


	correlated_pos_16_0 = [fct_scalar(w, correlated_pos_16_init0, 16) for w in interval]
	correlated_pos_16_1 = [fct_scalar(w, correlated_pos_16_init1, 16) for w in interval]
	correlated_pos_16_2 = [fct_scalar(w, correlated_pos_16_init2, 16) for w in interval]
	correlated_pos_16_3 = [fct_scalar(w, correlated_pos_16_init3, 16) for w in interval]

	ax1.plot(interval, correlated_pos_16_0, '-', color='tab:purple', markersize=1, label='%s %s' % (correlated_pos_16_idx[0][0], correlated_pos_16_idx[0][1]))
	ax1.plot(interval, correlated_pos_16_1, '-', color='tab:purple', markersize=1, label='%s %s' % (correlated_pos_16_idx[1][0], correlated_pos_16_idx[1][1]))
	ax1.plot(interval, correlated_pos_16_2, '-', color='tab:purple', markersize=1, label='%s %s' % (correlated_pos_16_idx[2][0], correlated_pos_16_idx[2][1]))
	ax1.plot(interval, correlated_pos_16_3, '-', color='tab:purple', markersize=1, label='%s %s' % (correlated_pos_16_idx[3][0], correlated_pos_16_idx[3][1]))

	# Degenerated case
	if len(correlated_pos_16_idx) == 6:
		correlated_pos_16_4 = [fct_scalar(w, correlated_pos_16_init4, 16) for w in interval]
		correlated_pos_16_5 = [fct_scalar(w, correlated_pos_16_init5, 16) for w in interval]
		ax1.plot(interval, correlated_pos_16_4, '-', color='tab:purple', markersize=1, label='%s %s' % (correlated_pos_16_idx[4][0], correlated_pos_16_idx[4][1]))
		ax1.plot(interval, correlated_pos_16_5, '-', color='tab:purple', markersize=1, label='%s %s' % (correlated_pos_16_idx[5][0], correlated_pos_16_idx[5][1]))


	correlated_pos_8_0 = [fct_scalar(w, correlated_pos_8_init0, 8) for w in interval]
	correlated_pos_8_1 = [fct_scalar(w, correlated_pos_8_init1, 8) for w in interval]
	correlated_pos_8_2 = [fct_scalar(w, correlated_pos_8_init2, 8) for w in interval]
	correlated_pos_8_3 = [fct_scalar(w, correlated_pos_8_init3, 8) for w in interval]
	correlated_pos_8_4 = [fct_scalar(w, correlated_pos_8_init4, 8) for w in interval]
	correlated_pos_8_5 = [fct_scalar(w, correlated_pos_8_init5, 8) for w in interval]
	correlated_pos_8_6 = [fct_scalar(w, correlated_pos_8_init6, 8) for w in interval]
	correlated_pos_8_7 = [fct_scalar(w, correlated_pos_8_init7, 8) for w in interval]
	correlated_pos_8_8 = [fct_scalar(w, correlated_pos_8_init8, 8) for w in interval]
	correlated_pos_8_9 = [fct_scalar(w, correlated_pos_8_init9, 8) for w in interval]
	correlated_pos_8_10 = [fct_scalar(w, correlated_pos_8_init10, 8) for w in interval]
	correlated_pos_8_11 = [fct_scalar(w, correlated_pos_8_init11, 8) for w in interval]
	correlated_pos_8_12 = [fct_scalar(w, correlated_pos_8_init12, 8) for w in interval]
	correlated_pos_8_13 = [fct_scalar(w, correlated_pos_8_init13, 8) for w in interval]
	correlated_pos_8_14 = [fct_scalar(w, correlated_pos_8_init14, 8) for w in interval]
	correlated_pos_8_15 = [fct_scalar(w, correlated_pos_8_init15, 8) for w in interval]
	correlated_pos_8_16 = [fct_scalar(w, correlated_pos_8_init16, 8) for w in interval]
	correlated_pos_8_17 = [fct_scalar(w, correlated_pos_8_init17, 8) for w in interval]
	
	ax1.plot(interval, correlated_pos_8_0, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[0][0], correlated_pos_8_idx[0][1]))
	ax1.plot(interval, correlated_pos_8_1, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[1][0], correlated_pos_8_idx[1][1]))
	ax1.plot(interval, correlated_pos_8_2, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[2][0], correlated_pos_8_idx[2][1]))
	ax1.plot(interval, correlated_pos_8_3, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[3][0], correlated_pos_8_idx[3][1]))
	ax1.plot(interval, correlated_pos_8_4, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[4][0], correlated_pos_8_idx[4][1]))
	ax1.plot(interval, correlated_pos_8_5, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[5][0], correlated_pos_8_idx[5][1]))
	ax1.plot(interval, correlated_pos_8_6, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[6][0], correlated_pos_8_idx[6][1]))
	ax1.plot(interval, correlated_pos_8_7, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[7][0], correlated_pos_8_idx[7][1]))
	ax1.plot(interval, correlated_pos_8_8, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[8][0], correlated_pos_8_idx[8][1]))
	ax1.plot(interval, correlated_pos_8_9, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[9][0], correlated_pos_8_idx[9][1]))
	ax1.plot(interval, correlated_pos_8_10, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[10][0], correlated_pos_8_idx[10][1]))
	ax1.plot(interval, correlated_pos_8_11, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[11][0], correlated_pos_8_idx[11][1]))
	ax1.plot(interval, correlated_pos_8_12, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[12][0], correlated_pos_8_idx[12][1]))
	ax1.plot(interval, correlated_pos_8_13, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[13][0], correlated_pos_8_idx[13][1]))
	ax1.plot(interval, correlated_pos_8_14, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[14][0], correlated_pos_8_idx[14][1]))
	ax1.plot(interval, correlated_pos_8_15, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[15][0], correlated_pos_8_idx[15][1]))
	ax1.plot(interval, correlated_pos_8_16, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[16][0], correlated_pos_8_idx[16][1]))
	ax1.plot(interval, correlated_pos_8_17, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[17][0], correlated_pos_8_idx[17][1]))

	# Non degenerated case
	if len(correlated_pos_8_idx) == 19:
		correlated_pos_8_18 = [fct_scalar(w, correlated_pos_8_init18, 8) for w in interval]
		ax1.plot(interval, correlated_pos_8_18, '-', color='tab:orange', markersize=1, label='%s %s' % (correlated_pos_8_idx[18][0], correlated_pos_8_idx[18][1]))
		

	uncorrelated_0_0 = [fct_scalar(w, uncorrelated_0_init0, 0) for w in interval]
	uncorrelated_0_1 = [fct_scalar(w, uncorrelated_0_init1, 0) for w in interval]
	uncorrelated_0_2 = [fct_scalar(w, uncorrelated_0_init2, 0) for w in interval]
	uncorrelated_0_3 = [fct_scalar(w, uncorrelated_0_init3, 0) for w in interval]
	uncorrelated_0_4 = [fct_scalar(w, uncorrelated_0_init4, 0) for w in interval]
	uncorrelated_0_5 = [fct_scalar(w, uncorrelated_0_init5, 0) for w in interval]
	uncorrelated_0_6 = [fct_scalar(w, uncorrelated_0_init6, 0) for w in interval]
	uncorrelated_0_7 = [fct_scalar(w, uncorrelated_0_init7, 0) for w in interval]
	uncorrelated_0_8 = [fct_scalar(w, uncorrelated_0_init8, 0) for w in interval]
	uncorrelated_0_9 = [fct_scalar(w, uncorrelated_0_init9, 0) for w in interval]
	uncorrelated_0_10 = [fct_scalar(w, uncorrelated_0_init10, 0) for w in interval]
	uncorrelated_0_11 = [fct_scalar(w, uncorrelated_0_init11, 0) for w in interval]

	ax1.plot(interval, uncorrelated_0_0, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[0][0], uncorrelated_0_idx[0][1]))
	ax1.plot(interval, uncorrelated_0_1, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[1][0], uncorrelated_0_idx[1][1]))
	ax1.plot(interval, uncorrelated_0_2, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[2][0], uncorrelated_0_idx[2][1]))
	ax1.plot(interval, uncorrelated_0_3, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[3][0], uncorrelated_0_idx[3][1]))
	ax1.plot(interval, uncorrelated_0_4, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[4][0], uncorrelated_0_idx[4][1]))
	ax1.plot(interval, uncorrelated_0_5, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[5][0], uncorrelated_0_idx[5][1]))
	ax1.plot(interval, uncorrelated_0_6, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[6][0], uncorrelated_0_idx[6][1]))
	ax1.plot(interval, uncorrelated_0_7, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[7][0], uncorrelated_0_idx[7][1]))
	ax1.plot(interval, uncorrelated_0_8, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[8][0], uncorrelated_0_idx[8][1]))
	ax1.plot(interval, uncorrelated_0_9, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[9][0], uncorrelated_0_idx[9][1]))
	ax1.plot(interval, uncorrelated_0_10, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[10][0], uncorrelated_0_idx[10][1]))
	ax1.plot(interval, uncorrelated_0_11, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[11][0], uncorrelated_0_idx[11][1]))

	# Non degenerated case
	if len(uncorrelated_0_idx) == 16:
		uncorrelated_0_12 = [fct_scalar(w, uncorrelated_0_init12, 0) for w in interval]
		uncorrelated_0_13 = [fct_scalar(w, uncorrelated_0_init13, 0) for w in interval]
		uncorrelated_0_14 = [fct_scalar(w, uncorrelated_0_init14, 0) for w in interval]
		uncorrelated_0_15 = [fct_scalar(w, uncorrelated_0_init15, 0) for w in interval]
		ax1.plot(interval, uncorrelated_0_12, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[12][0], uncorrelated_0_idx[12][1]))
		ax1.plot(interval, uncorrelated_0_13, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[13][0], uncorrelated_0_idx[13][1]))
		ax1.plot(interval, uncorrelated_0_14, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[14][0], uncorrelated_0_idx[14][1]))
		ax1.plot(interval, uncorrelated_0_15, '-', color='tab:blue', markersize=1, label='%s %s' % (uncorrelated_0_idx[15][0], uncorrelated_0_idx[15][1]))


	correlated_neg_8_0 = [fct_scalar(w, correlated_neg_8_init0, -8) for w in interval]
	correlated_neg_8_1 = [fct_scalar(w, correlated_neg_8_init1, -8) for w in interval]
	correlated_neg_8_2 = [fct_scalar(w, correlated_neg_8_init2, -8) for w in interval]
	correlated_neg_8_3 = [fct_scalar(w, correlated_neg_8_init3, -8) for w in interval]
	correlated_neg_8_4 = [fct_scalar(w, correlated_neg_8_init4, -8) for w in interval]
	correlated_neg_8_5 = [fct_scalar(w, correlated_neg_8_init5, -8) for w in interval]
	correlated_neg_8_6 = [fct_scalar(w, correlated_neg_8_init6, -8) for w in interval]
	correlated_neg_8_7 = [fct_scalar(w, correlated_neg_8_init7, -8) for w in interval]
	correlated_neg_8_8 = [fct_scalar(w, correlated_neg_8_init8, -8) for w in interval]
	correlated_neg_8_9 = [fct_scalar(w, correlated_neg_8_init9, -8) for w in interval]
	correlated_neg_8_10 = [fct_scalar(w, correlated_neg_8_init10, -8) for w in interval]
	correlated_neg_8_11 = [fct_scalar(w, correlated_neg_8_init11, -8) for w in interval]
	correlated_neg_8_12 = [fct_scalar(w, correlated_neg_8_init12, -8) for w in interval]
	correlated_neg_8_13 = [fct_scalar(w, correlated_neg_8_init13, -8) for w in interval]
	correlated_neg_8_14 = [fct_scalar(w, correlated_neg_8_init14, -8) for w in interval]
	correlated_neg_8_15 = [fct_scalar(w, correlated_neg_8_init15, -8) for w in interval]
	correlated_neg_8_16 = [fct_scalar(w, correlated_neg_8_init16, -8) for w in interval]
	correlated_neg_8_17 = [fct_scalar(w, correlated_neg_8_init17, -8) for w in interval]
	
	ax1.plot(interval, correlated_neg_8_0, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[0][0], correlated_neg_8_idx[0][1]))
	ax1.plot(interval, correlated_neg_8_1, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[1][0], correlated_neg_8_idx[1][1]))
	ax1.plot(interval, correlated_neg_8_2, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[2][0], correlated_neg_8_idx[2][1]))
	ax1.plot(interval, correlated_neg_8_3, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[3][0], correlated_neg_8_idx[3][1]))
	ax1.plot(interval, correlated_neg_8_4, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[4][0], correlated_neg_8_idx[4][1]))
	ax1.plot(interval, correlated_neg_8_5, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[5][0], correlated_neg_8_idx[5][1]))
	ax1.plot(interval, correlated_neg_8_6, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[6][0], correlated_neg_8_idx[6][1]))
	ax1.plot(interval, correlated_neg_8_7, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[7][0], correlated_neg_8_idx[7][1]))
	ax1.plot(interval, correlated_neg_8_8, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[8][0], correlated_neg_8_idx[8][1]))
	ax1.plot(interval, correlated_neg_8_9, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[9][0], correlated_neg_8_idx[9][1]))
	ax1.plot(interval, correlated_neg_8_10, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[10][0], correlated_neg_8_idx[10][1]))
	ax1.plot(interval, correlated_neg_8_11, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[11][0], correlated_neg_8_idx[11][1]))
	ax1.plot(interval, correlated_neg_8_12, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[12][0], correlated_neg_8_idx[12][1]))
	ax1.plot(interval, correlated_neg_8_13, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[13][0], correlated_neg_8_idx[13][1]))
	ax1.plot(interval, correlated_neg_8_14, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[14][0], correlated_neg_8_idx[14][1]))
	ax1.plot(interval, correlated_neg_8_15, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[15][0], correlated_neg_8_idx[15][1]))
	ax1.plot(interval, correlated_neg_8_16, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[16][0], correlated_neg_8_idx[16][1]))
	ax1.plot(interval, correlated_neg_8_17, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[17][0], correlated_neg_8_idx[17][1]))


	# Non degenerated case
	if len(correlated_neg_8_idx) == 19:
		correlated_neg_8_18 = [fct_scalar(w, correlated_neg_8_init18, -8) for w in interval]
		ax1.plot(interval, correlated_neg_8_18, '-', color='tab:green', markersize=1, label='%s %s' % (correlated_neg_8_idx[18][0], correlated_neg_8_idx[18][1]))


	correlated_neg_16_0 = [fct_scalar(w, correlated_neg_16_init0, -16) for w in interval]
	correlated_neg_16_1 = [fct_scalar(w, correlated_neg_16_init1, -16) for w in interval]
	correlated_neg_16_2 = [fct_scalar(w, correlated_neg_16_init2, -16) for w in interval]
	correlated_neg_16_3 = [fct_scalar(w, correlated_neg_16_init3, -16) for w in interval]

	ax1.plot(interval, correlated_neg_16_0, '-', color='tab:brown', markersize=1, label='%s %s' % (correlated_neg_16_idx[0][0], correlated_neg_16_idx[0][1]))
	ax1.plot(interval, correlated_neg_16_1, '-', color='tab:brown', markersize=1, label='%s %s' % (correlated_neg_16_idx[1][0], correlated_neg_16_idx[1][1]))
	ax1.plot(interval, correlated_neg_16_2, '-', color='tab:brown', markersize=1, label='%s %s' % (correlated_neg_16_idx[2][0], correlated_neg_16_idx[2][1]))
	ax1.plot(interval, correlated_neg_16_3, '-', color='tab:brown', markersize=1, label='%s %s' % (correlated_neg_16_idx[3][0], correlated_neg_16_idx[3][1]))

	# Degenerated case
	if len(correlated_neg_16_idx) == 6:
		correlated_neg_16_4 = [fct_scalar(w, correlated_neg_16_init4, -16) for w in interval]
		correlated_neg_16_5 = [fct_scalar(w, correlated_neg_16_init5, -16) for w in interval]
		ax1.plot(interval, correlated_neg_16_4, '-', color='tab:brown', markersize=1, label='%s %s' % (correlated_neg_16_idx[4][0], correlated_neg_16_idx[4][1]))
		ax1.plot(interval, correlated_neg_16_5, '-', color='tab:brown', markersize=1, label='%s %s' % (correlated_neg_16_idx[5][0], correlated_neg_16_idx[5][1]))


	correlated_neg_24_0 = [fct_scalar(w, correlated_neg_24_init0, -24) for w in interval]
	ax1.plot(interval, correlated_neg_24_0, '-', color='tab:pink', markersize=1, label='%s %s' % (correlated_neg_24_idx[0][0], correlated_neg_24_idx[0][1]))

	# Degenerated case
	if len(correlated_neg_24_idx) == 2:
		correlated_neg_24_1 = [fct_scalar(w, correlated_neg_24_init1, -24) for w in interval]
		ax1.plot(interval, correlated_neg_24_1, '-', color='tab:pink', markersize=1, label='%s %s' % (correlated_neg_24_idx[1][0], correlated_neg_24_idx[1][1]))


	""" Find the functions according to the Ks and kappas with correct function """

	inter_correlated_pos_16_0 = find_inter(correct_init0, correlated_pos_16_init0, 16)
	inter_correlated_pos_16_1 = find_inter(correct_init0, correlated_pos_16_init1, 16)
	inter_correlated_pos_16_2 = find_inter(correct_init0, correlated_pos_16_init2, 16)
	inter_correlated_pos_16_3 = find_inter(correct_init0, correlated_pos_16_init3, 16)

	inter_correlated_pos_16 = [inter_correlated_pos_16_0, inter_correlated_pos_16_1, inter_correlated_pos_16_2, inter_correlated_pos_16_3]

	# Degenerated case
	if len(correlated_pos_16_idx) == 6:
		inter_correlated_pos_16_4 = find_inter(correct_init0, correlated_pos_16_init4, 16)
		inter_correlated_pos_16_5 = find_inter(correct_init0, correlated_pos_16_init5, 16)

		inter_correlated_pos_16.append(inter_correlated_pos_16_4)
		inter_correlated_pos_16.append(inter_correlated_pos_16_5)

	# Drop values < 0 and > 1
	inter_correlated_pos_16 = [w for w in inter_correlated_pos_16 if (w > 0) and (w < 1)]

	# Plot the intersection values
	# for w in inter_correlated_pos_16:
		# ax1.axvline(x=w, linestyle='--', color='tab:purple', markersize=1, label='inter_correlated_pos_16')

	inter_correlated_pos_8_0 = find_inter(correct_init0, correlated_pos_8_init0, 8)
	inter_correlated_pos_8_1 = find_inter(correct_init0, correlated_pos_8_init1, 8)
	inter_correlated_pos_8_2 = find_inter(correct_init0, correlated_pos_8_init2, 8)
	inter_correlated_pos_8_3 = find_inter(correct_init0, correlated_pos_8_init3, 8)
	inter_correlated_pos_8_4 = find_inter(correct_init0, correlated_pos_8_init4, 8)
	inter_correlated_pos_8_5 = find_inter(correct_init0, correlated_pos_8_init5, 8)
	inter_correlated_pos_8_6 = find_inter(correct_init0, correlated_pos_8_init6, 8)
	inter_correlated_pos_8_7 = find_inter(correct_init0, correlated_pos_8_init7, 8)
	inter_correlated_pos_8_8 = find_inter(correct_init0, correlated_pos_8_init8, 8)
	inter_correlated_pos_8_9 = find_inter(correct_init0, correlated_pos_8_init9, 8)
	inter_correlated_pos_8_10 = find_inter(correct_init0, correlated_pos_8_init10, 8)
	inter_correlated_pos_8_11 = find_inter(correct_init0, correlated_pos_8_init11, 8)
	inter_correlated_pos_8_12 = find_inter(correct_init0, correlated_pos_8_init12, 8)
	inter_correlated_pos_8_13 = find_inter(correct_init0, correlated_pos_8_init13, 8)
	inter_correlated_pos_8_14 = find_inter(correct_init0, correlated_pos_8_init14, 8)
	inter_correlated_pos_8_15 = find_inter(correct_init0, correlated_pos_8_init15, 8)
	inter_correlated_pos_8_16 = find_inter(correct_init0, correlated_pos_8_init16, 8)
	inter_correlated_pos_8_17 = find_inter(correct_init0, correlated_pos_8_init17, 8)

	inter_correlated_pos_8 = [inter_correlated_pos_8_0, inter_correlated_pos_8_1, inter_correlated_pos_8_2, inter_correlated_pos_8_3,
							  inter_correlated_pos_8_4, inter_correlated_pos_8_5, inter_correlated_pos_8_6, inter_correlated_pos_8_7,
							  inter_correlated_pos_8_8, inter_correlated_pos_8_9, inter_correlated_pos_8_10, inter_correlated_pos_8_11,
							  inter_correlated_pos_8_12, inter_correlated_pos_8_13, inter_correlated_pos_8_14, inter_correlated_pos_8_15,
							  inter_correlated_pos_8_16, inter_correlated_pos_8_17]
	
	# Non degenerated case
	if len(correlated_pos_8_idx) == 19:
		inter_correlated_pos_8_18 = find_inter(correct_init0, correlated_pos_8_init18, 8)
		inter_correlated_pos_8.append(inter_correlated_pos_8_18)
		
	# Drop values < 0 and > 1
	inter_correlated_pos_8 = [w for w in inter_correlated_pos_8 if (w > 0) and (w < 1)]

	# Plot the intersection values
	# for w in inter_correlated_pos_8:
		# ax1.axvline(x=w, linestyle='--', color='tab:orange', markersize=1, label='inter_correlated_pos_8')


	inter_uncorrelated_0_0 = find_inter(correct_init0, uncorrelated_0_init0, 0)
	inter_uncorrelated_0_1 = find_inter(correct_init0, uncorrelated_0_init1, 0)
	inter_uncorrelated_0_2 = find_inter(correct_init0, uncorrelated_0_init2, 0)
	inter_uncorrelated_0_3 = find_inter(correct_init0, uncorrelated_0_init3, 0)
	inter_uncorrelated_0_4 = find_inter(correct_init0, uncorrelated_0_init4, 0)
	inter_uncorrelated_0_5 = find_inter(correct_init0, uncorrelated_0_init5, 0)
	inter_uncorrelated_0_6 = find_inter(correct_init0, uncorrelated_0_init6, 0)
	inter_uncorrelated_0_7 = find_inter(correct_init0, uncorrelated_0_init7, 0)
	inter_uncorrelated_0_8 = find_inter(correct_init0, uncorrelated_0_init8, 0)
	inter_uncorrelated_0_9 = find_inter(correct_init0, uncorrelated_0_init9, 0)
	inter_uncorrelated_0_10 = find_inter(correct_init0, uncorrelated_0_init10, 0)
	inter_uncorrelated_0_11 = find_inter(correct_init0, uncorrelated_0_init11, 0)

	inter_uncorrelated_0 = [inter_uncorrelated_0_0, inter_uncorrelated_0_1, inter_uncorrelated_0_2, inter_uncorrelated_0_3,
							inter_uncorrelated_0_4, inter_uncorrelated_0_5, inter_uncorrelated_0_6, inter_uncorrelated_0_7,
							inter_uncorrelated_0_8, inter_uncorrelated_0_9, inter_uncorrelated_0_10, inter_uncorrelated_0_11]

	# Non degenerated case
	if len(uncorrelated_0_idx) == 16:
		inter_uncorrelated_0_12 = find_inter(correct_init0, uncorrelated_0_init12, 0)
		inter_uncorrelated_0_13 = find_inter(correct_init0, uncorrelated_0_init13, 0)
		inter_uncorrelated_0_14 = find_inter(correct_init0, uncorrelated_0_init14, 0)
		inter_uncorrelated_0_15 = find_inter(correct_init0, uncorrelated_0_init15, 0)

		inter_uncorrelated_0.append(inter_uncorrelated_0_12)
		inter_uncorrelated_0.append(inter_uncorrelated_0_13)
		inter_uncorrelated_0.append(inter_uncorrelated_0_14)
		inter_uncorrelated_0.append(inter_uncorrelated_0_15)

	# Drop values < 0 and > 1
	inter_uncorrelated_0 = [w for w in inter_uncorrelated_0 if (w > 0) and (w < 1)]

	# Plot the intersection values
	# for w in inter_uncorrelated_0:
		# ax1.axvline(x=w, linestyle='--', color='tab:blue', markersize=1, label='inter_uncorrelated_0')


	inter_correlated_neg_8_0 = find_inter(correct_init0, correlated_neg_8_init0, -8)
	inter_correlated_neg_8_1 = find_inter(correct_init0, correlated_neg_8_init1, -8)
	inter_correlated_neg_8_2 = find_inter(correct_init0, correlated_neg_8_init2, -8)
	inter_correlated_neg_8_3 = find_inter(correct_init0, correlated_neg_8_init3, -8)
	inter_correlated_neg_8_4 = find_inter(correct_init0, correlated_neg_8_init4, -8)
	inter_correlated_neg_8_5 = find_inter(correct_init0, correlated_neg_8_init5, -8)
	inter_correlated_neg_8_6 = find_inter(correct_init0, correlated_neg_8_init6, -8)
	inter_correlated_neg_8_7 = find_inter(correct_init0, correlated_neg_8_init7, -8)
	inter_correlated_neg_8_8 = find_inter(correct_init0, correlated_neg_8_init8, -8)
	inter_correlated_neg_8_9 = find_inter(correct_init0, correlated_neg_8_init9, -8)
	inter_correlated_neg_8_10 = find_inter(correct_init0, correlated_neg_8_init10, -8)
	inter_correlated_neg_8_11 = find_inter(correct_init0, correlated_neg_8_init11, -8)
	inter_correlated_neg_8_12 = find_inter(correct_init0, correlated_neg_8_init12, -8)
	inter_correlated_neg_8_13 = find_inter(correct_init0, correlated_neg_8_init13, -8)
	inter_correlated_neg_8_14 = find_inter(correct_init0, correlated_neg_8_init14, -8)
	inter_correlated_neg_8_15 = find_inter(correct_init0, correlated_neg_8_init15, -8)
	inter_correlated_neg_8_16 = find_inter(correct_init0, correlated_neg_8_init16, -8)
	inter_correlated_neg_8_17 = find_inter(correct_init0, correlated_neg_8_init17, -8)

	inter_correlated_neg_8 = [inter_correlated_neg_8_0, inter_correlated_neg_8_1, inter_correlated_neg_8_2, inter_correlated_neg_8_3,
							  inter_correlated_neg_8_4, inter_correlated_neg_8_5, inter_correlated_neg_8_6, inter_correlated_neg_8_7,
							  inter_correlated_neg_8_8, inter_correlated_neg_8_9, inter_correlated_neg_8_10, inter_correlated_neg_8_11,
							  inter_correlated_neg_8_12, inter_correlated_neg_8_13, inter_correlated_neg_8_14, inter_correlated_neg_8_15,
							  inter_correlated_neg_8_16, inter_correlated_neg_8_17]
	
	# Non degenerated case
	if len(correlated_neg_8_idx) == 19:
		inter_correlated_neg_8_18 = find_inter(correct_init0, correlated_neg_8_init18, -8)
		inter_correlated_neg_8.append(inter_correlated_neg_8_18)
		
	# Drop values < 0 and > 1
	inter_correlated_neg_8 = [w for w in inter_correlated_neg_8 if (w > 0) and (w < 1)]

	# Plot the intersection values
	# for w in inter_correlated_neg_8:
		# ax1.axvline(x=w, linestyle='--', color='tab:green', markersize=1, label='inter_correlated_neg_8')


	inter_correlated_neg_16_0 = find_inter(correct_init0, correlated_neg_16_init0, -16)
	inter_correlated_neg_16_1 = find_inter(correct_init0, correlated_neg_16_init1, -16)
	inter_correlated_neg_16_2 = find_inter(correct_init0, correlated_neg_16_init2, -16)
	inter_correlated_neg_16_3 = find_inter(correct_init0, correlated_neg_16_init3, -16)

	inter_correlated_neg_16 = [inter_correlated_neg_16_0, inter_correlated_neg_16_1, inter_correlated_neg_16_2, inter_correlated_neg_16_3]

	# Degenerated case
	if len(correlated_neg_16_idx) == 6:
		inter_correlated_neg_16_4 = find_inter(correct_init0, correlated_neg_16_init4, -16)
		inter_correlated_neg_16_5 = find_inter(correct_init0, correlated_neg_16_init5, -16)

		inter_correlated_neg_16.append(inter_correlated_neg_16_4)
		inter_correlated_neg_16.append(inter_correlated_neg_16_5)

	# Drop values < 0 and > 1
	inter_correlated_neg_16 = [w for w in inter_correlated_neg_16 if (w > 0) and (w < 1)]

	# Plot the intersection values
	# for w in inter_correlated_neg_16:
		# ax1.axvline(x=w, linestyle='--', color='tab:brown', markersize=1, label='inter_correlated_neg_16')


	inter_correlated_neg_24_0 = find_inter(correct_init0, correlated_neg_24_init0, -24)
	inter_correlated_neg_24 = [inter_correlated_neg_24_0]

	# Degenerated case
	if len(correlated_neg_24_idx) == 2:
		inter_correlated_neg_24_1 = find_inter(correct_init0, correlated_neg_24_init1, -24)
		inter_correlated_neg_24.append(inter_correlated_neg_24_1)

	# Drop values < 0 and > 1
	inter_correlated_neg_24 = [w for w in inter_correlated_neg_24 if (w > 0) and (w < 1)]

	# Plot the intersection values
	# for w in inter_correlated_neg_24:
		# ax1.axvline(x=w, linestyle='--', color='tab:pink', markersize=1, label='inter_correlated_neg_24')


	inter = inter_correlated_pos_16
	inter += inter_correlated_pos_8
	inter += inter_uncorrelated_0
	inter += inter_correlated_neg_8
	inter += inter_correlated_neg_16
	inter += inter_correlated_neg_24
	...
	ax2.plot(inter, rank, color='tab:red')
