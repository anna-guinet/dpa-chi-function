...
def find_wr(a, b):
	...
	the scalar product of an  nonsolution hypothesis.
...
def find_rank(wr, w0):
	"""
	Return the list of ranks for the solution kappa hypothesis.
...
def sim_1bit_to_csv(n, i, K, kappa, num_sim):
	...
	for df in [rank_wr_df1, rank_wr_df2, rank_wr_df3, rank_wr_df4]:
		file_name = r'./csv/1bit_sq_num-sim=%s_K=%s_kappa=%s_i=%s_rank%s.csv' % (num_sim, K, kappa, i, num_rank)
